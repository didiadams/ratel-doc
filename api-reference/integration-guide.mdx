...
Ratel Security is an enterprise-grade Anti-Money Laundering (AML) and Combating the Financing of Terrorism (CFT) platform built for African financial institutions. Our API enables you to:
...
7. [How Screening Works](#how-screening-works)
8. [Webhooks](#webhooks)
...
| `channel`               | `string` | ✅       | `MOBILE_APP`, `INTERNET_BANKING`, `USSD`, `ATM`, `POS`, `BRANCH`, `API`, `AGENT`                                    |
...
| ------------------- | -------------------------------- | -------------------- |
| `PENDING`           | Submitted, awaiting verification | Score 40, `REVIEW`   |
| `DOCUMENT_UPLOADED` | ID documents uploaded            | Score 20, `APPROVE`  |
| `NIN_VERIFIED`      | NIN check passed                 | Score 0, `APPROVE`   |
| `BVN_VERIFIED`      | BVN check passed                 | Score 0, `APPROVE`   |
...
| ------------------------------------------------- | ---------- | -------- |
| **APPROVED**                                      | 0          | APPROVE  |
| **NIN_VERIFIED / BVN_VERIFIED / LIVENESS_PASSED** | 0          | APPROVE  |
| **PENDING / DOCUMENT_UPLOADED**                   | 20         | APPROVE  |
