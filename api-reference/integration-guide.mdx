...
<Note>
  **Idempotency:** Sending the same `externalId` twice returns the cached
  verdict without re-scree-ng. This makes retries safe.
</Note>-
-
----
...
| `lastName`    | `-ring` | ✅       | Last name for cross-match     |
...
Public endpoint — n-authentication required. Use this to monitor system availability.
