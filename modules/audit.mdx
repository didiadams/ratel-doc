...
```bash
curl -X GET "https://api.ratel.security/v1/audit/events?resourceType=cases&action=UPDATE&from=2026-05-01T00:00:00Z&to=2026-05-16T23:59:59Z&page=1&limit=20" \
...
```bash
curl -X GET https://api.ratel.security/v1/audit/verify \
  -H "Authorization: Bearer <access_token>"
```
